...
export default function CartFloatingBar() {
    ...
    return (
        <AnimatePresence>
            {show && (
                <div className="fixed bottom-0 left-0 right-0 z-[90] flex justify-center pointer-events-none sm:bottom-10 px-0 sm:px-4">
                    <motion.div
                    ...
                    >
                        <div className="overflow-hidden rounded-t-2xl sm:rounded-2xl border-t border-x sm:border border-white/20 bg-white/95 shadow-[0_20px_50px_rgba(0,0,0,0.15)] backdrop-blur-2xl dark:border-white/10 dark:bg-neutral-900/95 dark:shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
