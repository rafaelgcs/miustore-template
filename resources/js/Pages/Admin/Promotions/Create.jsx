...
import { ArrowLeft, Save, Tag, Calendar, Target, Check, X, Search, Info, Plus } from 'lucide-react';
import { useState } from 'react';

export default function Create({ auth, products, categories, collections }) {
        ...
        <AuthenticatedLayout
            ...
            header={
                <div className="flex items-center gap-4">
                    ...
                    <h2 className="text-2xl font-bold tracking-tight text-slate-900 dark:text-slate-100">Nova Promoção</h2>
                </div>
            }
        >
            <Head title="Criar Promoção" />
                        ...
                        <div className="rounded-[2.5rem] border border-slate-200/80 bg-white/80 p-8 shadow-xl backdrop-blur-xl dark:border-white/10 dark:bg-slate-950/80">
                            <div className="mb-8 flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-slate-500 dark:text-slate-400">Configure os gatilhos e benefícios.</p>
                                </div>
                            </div>
                        ...
                        <div className="rounded-[2.5rem] border border-slate-200/80 bg-white/80 p-8 shadow-xl backdrop-blur-xl dark:border-white/10 dark:bg-slate-950/80">
                            <div className="mb-8 flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-slate-500 dark:text-slate-400">Selecione produtos, categorias ou coleções.</p>
                                </div>
                            </div>
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="rounded-[2.5rem] border border-slate-200/80 bg-white/80 p-8 shadow-xl backdrop-blur-xl dark:border-white/10 dark:bg-slate-950/80">
                            ...
                            >
                                ...
                                {processing ? 'Salvando...' : 'Criar Promoção'}
                            </button>
                        </div>
                    </div>
                </div>
