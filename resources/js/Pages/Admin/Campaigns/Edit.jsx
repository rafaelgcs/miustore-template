...
export default function Edit({ auth, campaign, categories, products }) {
    ...
    const [preview, setPreview] = useState(campaign.image ? `/storage/${campaign.image}` : null);
        ...
        <AuthenticatedLayout
            ...
            header={
                <div className="flex items-center gap-4">
                    ...
                    <h2 className="text-2xl font-bold tracking-tight text-slate-900 dark:text-slate-100">Editar Campanha</h2>
                </div>
            }
        >
            <Head title={`Editar ${campaign.title}`} />
