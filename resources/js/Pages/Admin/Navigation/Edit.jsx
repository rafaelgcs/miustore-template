            ...
            header={
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        ...
                        <h1 className="text-3xl font-bold text-slate-900 dark:text-white">Editar Item de Menu</h1>
                    </div>
                    <Link
                    ...
                    <form onSubmit={submit} className="space-y-8">
                        ...
                        {data.type === 'mega' && (
                            <div className="pt-6 border-t border-slate-100 dark:border-slate-800 space-y-4">
                                ...
                                <p className="text-xs text-slate-500 font-medium">Edite o conteúdo do mega menu abaixo.</p>
                                <textarea
