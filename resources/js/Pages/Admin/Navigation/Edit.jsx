...
export default function Edit({ auth, menu }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        put(route('admin.navigation.update', menu.id));
    };

    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-slate-800 dark:text-slate-200 leading-tight">Editar Item de Menu</h2>}
        >
                        ...
                        <form onSubmit={submit} className="p-6 space-y-6">
                            ...
                            {data.type === 'mega' && (
                                <div className="pt-6 border-t border-slate-100 dark:border-white/5 space-y-4">
                                    ...
                                    <p className="text-xs text-slate-500">Edite o conteúdo do mega menu abaixo.</p>
                                    <textarea
