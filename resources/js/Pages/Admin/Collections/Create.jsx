        ...
        <AuthenticatedLayout
            ...
            header={
                <div className="flex items-center gap-4">
                    ...
                    <h2 className="text-2xl font-bold tracking-tight text-slate-900 dark:text-slate-100">Nova Coleção</h2>
                </div>
            }
        >
            <Head title="Criar Coleção" />
            ...
            <form onSubmit={handleSubmit} className="mx-auto max-w-5xl space-y-8">
                    ...
                    <div className="rounded-[2.5rem] border border-slate-200/80 bg-white/80 p-8 shadow-xl backdrop-blur-xl dark:border-white/10 dark:bg-slate-950/80">
                        <div className="mb-8 flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-slate-500 dark:text-slate-400">Dados principais da coleção.</p>
                            </div>
                        </div>
                ...
                <div className="flex items-center justify-end gap-4">
                    ...
                    >
                        ...
                        {processing ? 'Salvando...' : 'Salvar Coleção'}
                    </button>
                </div>
            </form>
        </AuthenticatedLayout>
