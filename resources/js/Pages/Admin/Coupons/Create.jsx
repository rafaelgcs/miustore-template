...
export default function Create({ auth, promotions }) {
        ...
        <AuthenticatedLayout
            ...
            header={
                <div className="flex items-center gap-4">
                    ...
                    <h2 className="text-2xl font-bold tracking-tight text-slate-900 dark:text-slate-100">Novo Cupom</h2>
                </div>
            }
        >
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="rounded-[2.5rem] border border-slate-200/80 bg-white/80 p-8 shadow-xl backdrop-blur-xl dark:border-white/10 dark:bg-slate-950/80">
                        <div className="mb-8 flex items-center gap-4">
                            ...
                            <div>
                                <h3 className="text-xl font-bold text-slate-900 dark:text-slate-100">Configuração do Cupom</h3>
                                <p className="text-sm text-slate-500 dark:text-slate-400">Vincule uma regra de promoção a um código.</p>
                            </div>
                        </div>
                    ...
                    <div className="flex items-center justify-end gap-4">
                        ...
                        >
                            ...
                            {processing ? 'Salvando...' : 'Criar Cupom'}
                        </button>
                    </div>
                </form>
            </div>
