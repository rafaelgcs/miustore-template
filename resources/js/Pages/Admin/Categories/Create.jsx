        ...
        <AuthenticatedLayout
            ...
            header={
                <div className="flex items-center gap-4">
                    ...
                    <h2 className="text-2xl font-bold tracking-tight text-slate-900 dark:text-slate-100">Nova Categoria</h2>
                </div>
            }
        >
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="rounded-[2.5rem] border border-slate-200/80 bg-white/80 p-8 shadow-xl backdrop-blur-xl dark:border-white/10 dark:bg-slate-950/80">
                        <div className="mb-8 flex items-center gap-4">
                            ...
                            <div>
                                <h3 className="text-xl font-bold text-slate-900 dark:text-slate-100">Informações Básicas</h3>
                                <p className="text-sm text-slate-500 dark:text-slate-400">Defina o nome e a URL da nova categoria.</p>
                            </div>
                        </div>
